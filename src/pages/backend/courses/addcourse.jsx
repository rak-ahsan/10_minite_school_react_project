                    ...
                    <div className="container mt-3 justify-content-center d-flex">
                        <form className="row g-3" onSubmit={save} >
                            ...
                            <div className="mb-3 col-md-6">
                                ...
                                <Form.Select aria-label="Default select example" value={course.class} name='studentclass' onChange={input}>
                            ...
                            <div className="mb-3 col-md-6">
                                ...
                                <Form.Select aria-label="Default select example" name='subject' value={course.subject} onChange={input}>
                                    <option>Open this select menu</option>
