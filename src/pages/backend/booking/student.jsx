...
const Student = () => {
    ...
    const save = (e) => {
        ...
        axios.post(`http://localhost/ReactProject/api/api-insert-comment.php`, data).then(res => {
            axios.get(`http://localhost/ReactProject/api/api-fetch-comment.php`).then(res => {
